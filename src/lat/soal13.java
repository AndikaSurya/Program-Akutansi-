 ...
 * @author Asus
 */
public class soal13 extends javax.swing.JFrame {
...
if(jawab.getText().trim().isEmpty()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(soal13.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
